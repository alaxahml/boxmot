...
class BotSort(BaseTracker):
    ...
    def _lost_association(
        ...
        dists_lost = self._calculate_cost_matrix(self.lost_stracks, detections, use_motion=False, appearance_thresh=0.15, proximity_thresh=0.5)
        #print("DISTS_LOST", dists_lost)
